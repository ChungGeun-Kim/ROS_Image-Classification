...
start_position = [0, -1.57, 0, -1.57, -1.57, 0]   

Q = [0, -1.57, 0, -1.57, -1.57, 0]                # This value will change constantly. 
						    	     # Q[0] is base.  Q[1] is shoulder 
						   	     # Q[2] is elbow. Q[3] is wrist 1
							     # Q[4] is wrist 2.Q[5] is wrist 3 
						             # We use Q[0] and Q[1]. 
myo_data_x = 0
myo_data_y = 0
...
def move_point():
    ...
    try:
        ...
        g.trajectory.points = [
                JointTrajectoryPoint(positions=joints_pos, velocities=[0]*6, time_from_start=rospy.Duration(0.0)),
                JointTrajectoryPoint(positions=Q, velocities=[0]*6, time_from_start=rospy.Duration(1.0))]     # 0.01s is the minimum unit time to move the robot.
    ...
    try:
            ...
            while True:
                ...
                if (result == 'right'):
                    ...
                    Q[0] = 0.5
                    move_point() 
                elif(result == 'thumb_up'):
                    Q[1] = -2.0
		    move_point() 
		elif(result == 'thumb_down'):
                    Q[1] = -1.0
		    move_point()
		elif(result == 'supination'):
                    Q[5] = -2.0
		    move_point()
		elif(result == 'pronation'):
                    Q[5] = -1.0
		    move_point()
		elif(result == 'fist'):
                    start_point()
