...
while True:
    ...
    if contours == []:
        ...
        print("전처리 과정 : ", end_preprocess - start_preprocess)
        ...
        if cnt % 20 == 0:
            if(show_res == 'empty'):
                    ...
                    print("분류 및 전송 과정 : ", end_predict - start_predict)
                    #s1.send(commend.encode())
                    s1.send(datetime.utcnow().strftime('%S%f'))
